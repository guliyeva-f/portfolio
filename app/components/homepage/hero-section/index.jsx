  ...
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start gap-6 justify-evenly h-full p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-14">
            Hi, I’m <br />
            <span className="text-pink-500">{personalData.name}</span>
            <span className="text-pink-500"> {personalData.firstname}</span>
            {` — `} <br />
          ...
          {/* <div className="my-12 flex items-center gap-5">
            <Link
              ...
              target='_blank'
              className="transition-all text-pink-500 hover:scale-125 hover:text-pink-200 duration-300">
              <BsGithub size={30} />
            </Link>
            <Link href='#'
              className="transition-all text-pink-500 hover:scale-125 hover:text-pink-200 duration-300">
          ...
          <div className="flex items-center gap-3">
            <Link href="#contact" className="bg-linear-to-r to-pink-500 from-violet-600 p-px rounded-full transition-all duration-300 hover:from-pink-500 hover:to-violet-600">
              <button className="px-3 cursor-pointer text-xs md:px-8 py-3 md:py-4 bg-[#0d1224] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-1 hover:gap-3">
          ...
          <div className="overflow-hidden border-t-2 border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Fatima Guliyeva</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              ...
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">deepLearner:</span>
                <span className="text-orange-400">true</span>
                <span className="text-gray-400">,</span>
              </div>
              <div>
